...
?>
<div id="ibedu-quiz">
	<div id="ibedu-questions"></div>
	<div id="ibedu-quiz-buttons">
		<div id="ibedu-add-question">
			<?php
				printf(
					__( 'Add %s question.', 'ibeducator' ),
					'<select id="ibedu-question-type">' .
...
<input type="hidden" id="ibedu-quiz-lesson-id" value="<?php echo $lesson_id; ?>">
...
<script type="text/template" id="tpl-ibedu-multichoiceanswer">
...
<script type="text/template" id="tpl-ibedu-multiplechoicequestion">
...
<script type="text/template" id="tpl-ibedu-writtenanswerquestion">
<a class="question-header" href="#">
	<span class="text"><%= question %></span>
	<span class="question-trigger"></span>
</a>
